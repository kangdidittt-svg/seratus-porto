      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-1 group">
            <div className="w-16 h-16 flex items-center justify-center group-hover:opacity-80 transition-all duration-300">
            ...
            <div className="text-xl font-bold text-white hidden sm:block group-hover:text-white/80 transition-all duration-300 leading-tight">
                <div>Seratus</div>
                <div>Studio</div>
              </div>
          </Link>
